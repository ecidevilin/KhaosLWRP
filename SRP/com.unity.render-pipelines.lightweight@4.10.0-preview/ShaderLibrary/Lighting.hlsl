...
Light GetMainLight(float4 shadowCoord, float4 shadowCoord2, float4 shadowCoord3)
{
	Light light = GetMainLight();
	light.shadowAttenuation = MainLightRealtimeShadow(shadowCoord, shadowCoord2, shadowCoord3);
	return light;
}
